const products = [
    { id: 1, name: "Product 1", price: 25,desc:"Description of the product.Description of the Product 1"},
    { id: 2, name: "Product 2", price: 45 ,desc:"Description of the product.Description of the Product 2"},
    { id: 3, name: "Product 3", price: 30 ,desc:"Description of the product.Description of the Product 3"},
  ];
  const cart = {};
  const addToCart = (id) => {
